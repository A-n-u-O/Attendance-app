    ...
    return (
        <form onSubmit={addAttendance}>
            <div className="form-group">
                ...
                <input name="name" value={name} type="text" placeholder="student name" onChange={(e) => setName(e.target.value)} required />
            </div>

            <div className="form-group">
                <label htmlFor="class">Class</label><br/>
                <input name="class" value={classValue} type="text" placeholder="student class" onChange={(e) => setClassValue(e.target.value)} required />
            </div>
